...
export const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen bg-[#F4F7FC] flex flex-col justify-between items-center p-4 md:p-10 font-body relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white/40 backdrop-blur-md border border-white/50 rounded-[32px] p-4 md:p-8 shadow-[24px_24px_48px_rgba(0,0,0,0.03),-24px_-24px_48px_#ffffff] z-10 my-auto">
        ...
        <div className="hidden lg:flex lg:col-span-6 flex-col justify-center p-8 h-full relative select-none">
          ...
          >
            ...
            <p className="text-slate-600 font-medium max-w-md leading-relaxed mt-2">
              An AI-powered career guidance and learning platform designed for college students to build resumes, prepare for interviews, and master technical skills.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-10">
            ...
            >
              ...
              <div className="text-left">
                <h4 className="font-bold text-xs text-slate-800">AI Career Mentor</h4>
                <p className="text-[10px] text-slate-500 font-medium">Pathways & suggestions</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="text-left">
                <h4 className="font-bold text-xs text-slate-800">Resume Builder</h4>
                <p className="text-[10px] text-slate-500 font-medium font-semibold text-slate-500">AI-assisted templates</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="text-left">
                <h4 className="font-bold text-xs text-slate-800">ATS Analysis</h4>
                <p className="text-[10px] text-slate-500 font-medium">Optimize resume scores</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="text-left">
                <h4 className="font-bold text-xs text-slate-800">AI Interview Prep</h4>
                <p className="text-[10px] text-slate-500 font-medium">Realistic mock feedback</p>
              </div>
            </motion.div>
          </div>
        </div>
